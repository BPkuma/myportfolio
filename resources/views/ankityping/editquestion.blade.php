        ...
        <div class="mx-4 sm:px-8">
            <form method="post" action="{{route('post.update', $post)}}" enctype="multipart/form-data">
                ...
                <div class="md:flex items-center mt-8">
                    ...
                    <input type="text" name="answer" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="answwer" value="{{old('answer', $post->answer)}}" placeholder="answer">
                    </div>
                </div>
