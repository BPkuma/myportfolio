...
class DialogueSeeder extends Seeder
{
    ...
    {
        $user_name = auth()->user()->name ?? "ななし"; 
        
        $talks = [
            ['ジャスコ「 JavaScript おさらい ページへようこそ。」', null], 
            ['ジャスコ「 わたしは ジャスコ。でんせつ の'.$user_name.' さま を おまちして おりました。」', 'user_name'],
            ...
            ['ジャスコ「 '.$user_name.'さま おねがい です」',  'user_name'],
            ...
            ["ジャスコ「 あ、でも 上 の タイマー と 見 比べる と、少し 違和感 が・・・。 」", null],
            ...
            ["ジャスコ「 さすが は 伝説 の ".$user_name." さま です！」", 'user_name'],
            ["ジャスコ「 ".$user_name." さま、 世界には カウントダウン タイマー 以外 にも  聖なる アイテム が まだまだ 不足しています。」", 'user_name'],
