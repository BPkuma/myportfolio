...
class DialogueSeeder extends Seeder
{
    ...
    {
        $talks = [
            ['ジャスコ「 JavaScript おさらい ページへようこそ。」', null], 
            ['ジャスコ「 わたしは ジャスコ。でんせつ の ななし さま を おまちして おりました。」', 'user_name'],
            ...
            ['ジャスコ「 ななし さま おねがい です」',  'user_name'],
            ['ジャスコ「 どうか、よびの カウントダウンタイマー を つくって くださいませんか？」',  'q'],
            ...
            ['ジャスコ「 まず は 現在 の 日時 を 取得 します。こちら の コード を ご覧ください。」', 'code_now'],
            ...
            ["ジャスコ「 ただ、今 の 状態では 更新 ボタン を 押さない と リアルタイム で 残り時間 を 知ること は できません。 」", 'to_recalc'],
            ["スライム「 リ・・・？ 」", null],
            ...
            ["ジャスコ「 いかが ですか？ 」", 'sample2'],
            ["スライム「 ムニャ・・・ 」", null],
            ["ジャスコ「 ちゃんと カウント されて いますね。 」", null],
            ["ジャスコ「 あ、でも 上 の タイマー と 見 比べる と、少し 違和感 が・・・。 」", 'arrange'],
            ["ジャスコ「 残り の 秒数 が 1桁 に なると、全体 の 桁数 が 変わって しまっていますね。 」", null],
            ["ジャスコ「 String オブジェクト の padStart() メソッド を 使って 桁数 を 揃えましょう！ 」", 'code_padstart'],
            ["ジャスコ「 String オブジェクト は、( ) 内 の データ を 文字列型 に 変換 します。 」", null],
            ["ジャスコ「 padStart() メソッド は、第1引数 に 揃えたい 文字数 を 指定し、第2引数 には 足りない 場合 に 先頭 に 埋めたい 文字列 を 指定します。 」", null],
            ["ジャスコ「 今度 は どう で しょうか？ 」", 'sample3'],
            ["ジャスコ「 やりました！ 桁数 が ずれる こと なく 表示 されて いますね。これで 聖 なる カウントダウンタイマー の 予備 が 完成しました！ 」", null],
            ["ジャスコ「 これで 聖 なる カウントダウンタイマー の 予備 が 完成しました！ 」", null],
            ["ジャスコ「 さすが は 伝説 の ななし さま です！」", 'user_name'],
            ["ジャスコ「 ななし さま、 世界には カウントダウン タイマー 以外 にも  聖なる アイテム が まだまだ 不足しています。」", 'user_name'],
            ["ジャスコ「 どうか これから も 聖 なる アイテム の 複製 を 手伝って くださいね。」", 'q'],
            ["スライム「 グゥ・・・グゥ・・・ 」", 'complete'],
            [" ななし は 経験値 を 5 手 に 入れた ！ レベル が 1 に 上がった ！ ", null],
            [" トップ 画面 に 戻る ", null],
            ["", 'end'],
        ];
